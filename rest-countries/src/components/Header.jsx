...
const Header = () => {
  ...
  return (
    <Flex position="sticky" background={colorMode === "dark" ? "#2B3743" : "unset"} justifyContent={isLargerThan768 ? "space-between" : "space-around"} alignItems="center" paddingY="6" paddingX={isLargerThan768 ? "20" : "6"} boxShadow="base">
